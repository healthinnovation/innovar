...
#'   \item \bold{Cardinal}:North, South, Amazon Jungle, or Lima & Callao
#'   \item \bold{Trad_Cardinal}:Coastal and Andes Mountains are divided into North and South (e.g. South Andes Mountains)
#' }
#' 
